...
std::vector<vector3> Simplex::MyRigidBody::GetVertices(vector3 mins, vector3 maxes)
{
	std::vector<vector3> vertices;
	vertices.push_back(maxes);
	vertices.push_back(mins);
	vertices.push_back(vector3(maxes.x, maxes.y, mins.z));
	vertices.push_back(vector3(maxes.x, mins.y, mins.z));
	vertices.push_back(vector3(mins.x, maxes.y, mins.z));
	vertices.push_back(vector3(mins.x, mins.y, maxes.z));
	vertices.push_back(vector3(maxes.x, mins.y, mins.z));
	vertices.push_back(vector3(mins.x, maxes.y, mins.z));
	return vertices;
}
...
{
	// calculate the axes for each object
	vector3 axes[6];
	axes[0] = vector3(m_m4ToWorld * vector4(AXIS_X, 0.0f));
	axes[1] = vector3(m_m4ToWorld * vector4(AXIS_Y, 0.0f));
	axes[2] = vector3(m_m4ToWorld * vector4(AXIS_Z, 0.0f));
	axes[3] = vector3(a_pOther->m_m4ToWorld * vector4(AXIS_X, 0.0f));
	axes[4] = vector3(a_pOther->m_m4ToWorld * vector4(AXIS_Y, 0.0f));
	axes[5] = vector3(a_pOther->m_m4ToWorld * vector4(AXIS_Z, 0.0f));
	...
	// Compute common subexpressions. Add in a small value to
